...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 18, 2024 at 06:43 PM
...
INSERT INTO `events` (`EventID`, `EventTitle`, `Description`, `Date`, `Location`, `EventImg`, `Available`, `status`, `UserID`) VALUES
(1, 'Career Fair', 'Meet potential employers and explore job opportunities. Open to all graduating students.', '2024-07-23', 'Bulacan State University Gymnasium', 'uploads\\events\\Bulacan State University Gymnasium.jpg', 200, 1, 1),
(2, 'Science Symposium', 'Presentations and discussions on recent advancements in various fields of science.', '2024-07-24', 'Bulacan State University Gymnasium', 'uploads\\events\\Bulacan State University Gymnasium.jpg', 200, 1, 1),
(3, 'Sleep Over ', 'Sleep Over sa bahay ni James Raille Sition, Foods dala ni Mae Reyes then si adrian Tokis Sleep Over sa bahay ni James Raille Sition, Foods dala ni Mae Reyes then si adrian Tokis Sleep Over sa bahay ni James Raille Sition, Foods dala ni Mae Reyes then si adrian Tokis Sleep Over sa bahay ni James Raille Sition, Foods dala ni Mae Reyes then si adrian Tokis Sleep Over sa bahay ni James Raille Sition, Foods dala ni Mae Reyes then si adrian Tokis ', '2024-07-18', 'Adrian\'s House', 'uploads\\events\\sleepover.png', 30, 1, 1),
(4, 'Coding Bootcamp', 'Intensive coding bootcamp covering Python, JavaScript, and SQL. Ideal for beginners and intermediate coders.\r\n', '2024-07-25', 'Bulacan State University', 'uploads\\events\\Bulacan State University.jpg', 50, 1, 1),
(5, 'Art Exhibit', 'Showcase of student artworks from the Fine Arts department. Open to the public.\r\n', '2024-07-26', 'Bulacan State University Gymnasium', 'uploads\\events\\Bulacan State University Gymnasium.jpg', 50, 1, 1),
(6, 'Music Festival', 'Annual music festival featuring bands and solo artists from the university.\r\n', '2024-07-28', 'Bulacan State University Main Grounds', 'uploads\\events\\Bulacan State University Main Grounds.jpg', 50, 1, 1),
(7, 'Tech Startup Workshop', 'Workshop for aspiring tech entrepreneurs covering startup essentials and pitching techniques.', '2024-07-29', 'Innovate Hub Co-working Space', 'uploads\\events\\Innovate Hub Co-working Space.jpg', 10, 1, 1),
(8, 'Fashion Show', 'Annual fashion show featuring designs by students and local designers. Runway and exhibition.', '2024-07-30', 'Glamour Events Hall', 'uploads\\events\\Glamour Events Hall.jpg', 50, 1, 1),
(9, 'Food Festival', 'Celebration of local cuisine with food stalls, cooking demonstrations, and live music.', '2024-07-31', 'Culinary Delights Plaza', 'uploads\\events\\Culinary Delights Plaza.jpg', 1, 1, 1),
(10, 'Fitness Bootcamp', 'Intensive fitness bootcamp with certified trainers. Outdoor workout sessions and nutrition seminars.', '2024-07-20', 'FitZone Park', 'uploads\\events\\fitzone.jpg', 100, 1, 1),
(11, 'Artisan Market', 'Market showcasing handmade crafts, arts, and gourmet foods by local artisans. Shopping and live entertainment.', '2024-07-21', 'Artisan Alley', 'uploads\\events\\Artisan Alley.jpg', 50, 1, 15),
(43, 'q', 'q', '2024-07-01', 'Adrian', 'uploads/events/5d05498f-d3e8-4f3d-80af-f80070ec70d9.jpg', 50, 1, 1);
...
--
ALTER TABLE `myevents`
  MODIFY `MyEventID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
